...
CREATE TABLE `bai_dang_hoac_trao_doi` (
  ...
  `id_thong_tin_ca_nhan` int(11) DEFAULT NULL,
...
INSERT INTO `bai_dang_hoac_trao_doi` VALUES (101,111,1,'IT',1,'Java technology allows you to work and play in a secure computing environment.',2,124,'2014-02-11 00:00:00',1,0),(102,333,2,'English',0,'English is a West Germanic language that was first spoken in early medieval England ',5,125,'2015-03-06 00:00:00',0,1),(103,444,3,'Skills',1,'Most job-seekers wish they could unlock the secret formula to winning the hearts and minds of employers',9,14,'2016-11-12 00:00:00',0,0),(104,222,2,'Education',0,'The better news is that job-seekers with weaknesses',3,135,'2016-09-23 00:00:00',1,1);
