...
<div class="container target">
    <div class="row">
        <div class="col-sm-10">
            ...
            <h3> Title(Admin or User)</h3>
            <span class="fa fa-bell">2</span>

            <span class="fa fa-comments-o">3</spanclass>       
<br>
        </div>
      <div class="col-sm-2"><a href="/users" ><img title="profile image" class="img-circle img-responsive" src="images/profile-img.png"></a>
    ...
    <div class="row">
        <div class="col-sm-3">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item text-right"><span class="pull-left"><strong class="">Name</strong></span> Mr.Tuan</li>
                <li class="list-group-item text-right"><span class="pull-left"><strong class="">Date of birth</strong></span> 02/02/1996</li>
                    <li class="list-group-item text-right"><span class="pull-left"><strong class="">Address</strong></span> Da Nang</li>
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item text-right"><span class="pull-left"><strong class="">Likes</strong></span> 13</li>
                    <li class="list-group-item text-right"><span class="pull-left"><strong class="">Posts</strong></span> 37</li>
                        <li class="list-group-item text-right"><span class="pull-left"><strong class="">Comment</strong></span> 78</li>
            </ul>
            <div class="panel panel-default">
